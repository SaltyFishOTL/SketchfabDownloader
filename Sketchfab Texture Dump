...
(function () {
  ...
  let webGLTextureMap = {};
  let targetRenderingCtx;
  // auto choose context
  if (WebGL2RenderingContext) {
      targetRenderingCtx = WebGL2RenderingContext;
    } else if (WebGLRenderingContext) {
        targetRenderingCtx = WebGLRenderingContext;
    }else {
        _warn("can't find WebGLRenderingContext!");
    return;
  }
